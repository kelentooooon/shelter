...
const Navbar = () => {
  return (
    <>
      <nav className="navbar rounded-box shadow" style={{ backgroundColor: "#ffd800" }}>
        <div className="w-full md:flex md:items-center md:gap-2">
          ...
          >
            <ul className="menu md:menu-horizontal gap-2 p-0 text-base max-md:mt-2 font-bold font-title text-2xl"  style={{ backgroundColor: "#ffd800" }}>
              <li>
                <Link to="/">Home</Link>
              </li>
              <li>
